...
- **Escalation wiring** — the strict user-escalation list routed through `state/escalations.log` (and `PushNotification` when available). See [`docs/lifecycle.md`](docs/lifecycle.md) § "User escalation".
